...
const FoxSportsLogo = () => (
  <svg viewBox="0 0 120 50" className="h-8 md:h-10 w-auto fill-current">
...
const NatGeoLogo = () => (
  <svg viewBox="0 0 160 50" className="h-8 md:h-10 w-auto fill-current">
...
const MediaMonksLogo = () => (
  <svg viewBox="0 0 100 50" className="h-8 md:h-10 w-auto fill-current">
...
const TurnerLogo = () => (
  <svg viewBox="0 0 100 35" className="h-8 md:h-10 w-auto fill-current">
...
const MasterclassLogo = () => (
  <svg viewBox="0 0 40 50" className="h-8 md:h-10 w-auto fill-current">
...
const GoogleLogo = () => (
  <svg viewBox="0 0 90 35" className="h-8 md:h-10 w-auto fill-current">
    <text x="0" y="26" fontSize="24" fontWeight="400" fontFamily="Product Sans, Arial, sans-serif">Google</text>
  </svg>
);

const NetflixLogo = () => (
  <svg viewBox="0 0 110 35" className="h-8 md:h-10 w-auto fill-current">
    <text x="0" y="26" fontSize="20" fontWeight="700" fontFamily="Arial, sans-serif" letterSpacing="2">NETFLIX</text>
  </svg>
);

const BBCLogo = () => (
  <svg viewBox="0 0 80 35" className="h-8 md:h-10 w-auto fill-current">
        ...
        <div className="flex animate-scroll-right-to-left items-center w-max">
          {duplicatedPartners.map((partner, index) => (
            <div
              ...
              className="flex-shrink-0 px-8 md:px-12 flex items-center justify-center text-white/40 hover:text-white/60 transition-colors duration-300"
            >
              <partner.Logo />
            </div>
          ))}
