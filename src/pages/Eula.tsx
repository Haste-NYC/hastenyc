          ...
          <div className="text-foreground/80 text-sm leading-relaxed uppercase tracking-[0.04em] space-y-8 p-6">
            ...
            <div id="definitions">
              ...
              <div className="space-y-4">
                ...
                <p><span className="text-foreground font-medium">"Commercial Entity"</span> means any corporation, limited liability company, partnership, sole proprietorship, joint venture, government agency, or other business organization, including any subsidiary, parent company, affiliate, division, or department thereof, that (a) employs or engages more than five (5) individuals (whether full-time, part-time, contract, or freelance); or (b) generates annual gross revenue exceeding Two Hundred Fifty Thousand U.S. Dollars (US $250,000); or (c) operates as a post-production facility, broadcast network, streaming platform, studio, production company, media conglomerate, or advertising agency; or (d) uses the Software to process, conform, or migrate projects on behalf of third-party clients in exchange for compensation.</p>
