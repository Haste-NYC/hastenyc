        ...
        <main className="px-6 md:px-12 lg:px-24 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            <blockquote className="border-l-4 border-brand-pink pl-6 py-4 my-12">
              ...
              <cite className="text-3xl md:text-4xl font-bold uppercase mt-4 block bg-gradient-to-r from-brand-orange via-brand-pink to-brand-blue bg-clip-text text-transparent">— Conform</cite>
            </blockquote>
