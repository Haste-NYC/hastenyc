...
const GetConformStudio = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      <SEO
        title="Free90 -- Conform Studio 90-Day Free Trial"
        ...
        <section className="pt-32 pb-20">
          <div className="container mx-auto px-4">
            <div className="max-w-xl mx-auto text-center space-y-8">
              ...
              {!submitted ? (
                <div className="p-8 md:p-10 rounded-2xl text-center space-y-6 border border-white/[0.08] bg-black/40 backdrop-blur-md">
                  <div className="space-y-2">
                    <h1 className="text-2xl font-bold tracking-tight">
                      Claim Your 90-Day Free Trial
                    </h1>
                    <p className="text-sm text-muted-foreground">
                      Enter your email to get started with 90 days
                      of Conform&nbsp;Studio, completely&nbsp;free.
                    </p>
                  </div>
                ...
                <div className="glass-card p-8 md:p-10 rounded-2xl text-center space-y-4 border border-border backdrop-blur-sm">
